...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default="F:\Transfer\Courses - Masters PMS UoII_New2\Industry 4.0/assignment\computer vision\datasets\BSData\data.yaml", help="Path to the dataset YAML file.")
